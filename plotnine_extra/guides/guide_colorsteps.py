...
class guide_colorsteps(guide_colorbar):
    ...
    Like :class:`~plotnine.guides.guide_colorbar.guide_colorbar`
    but shows distinct color blocks instead of a continuous gradient.
    ...
    :class:`~plotnine.guides.guide_colorbar.guide_colorbar`.
    """
    ...
    available_aes: set[str] = field(
        init=False,
        default_factory=lambda: {"colour", "color", "fill"},
    )
