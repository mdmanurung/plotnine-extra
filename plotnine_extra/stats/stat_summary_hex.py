...
class stat_summary_hex(stat):
    ...
    See Also
    --------
    plotnine_extra.geoms.geom_hex : The default `geom` for this `stat`.
    plotnine_extra.stats.stat_bin_hex : Hex binning without z summary.
    plotnine_extra.stats.stat_summary_2d : Rectangular 2D summary.
    """
